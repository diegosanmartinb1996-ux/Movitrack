...
export const AMBIENT = {
  homeHero: U("photo-1533473359331-0135ef1b58bf"), // SUV Ford blanca, exterior claro
  homeCta: U("photo-1618843479313-40f8afb4b4d8"), // Mercedes-AMG GT premium
  ...
  contacto: U("photo-1503376780353-7e6692767b70"), // sedán premium negro, exterior
} as const;
